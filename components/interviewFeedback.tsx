    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                    ...
                    {item.better_answer && (
                      <div>
                        <h4 className="font-medium text-green-700 mb-2 flex items-center">
                          <span className="mr-2">🌟</span> Better Answer Example
                        </h4>
                      ...
                      <div>
                        ...
                        {item.strengths.length > 0 ? (
                          ...
                          <p className="text-gray-500 italic text-sm">
                            No specific strengths identified for this question.
                          </p>
                        )}
                      </div>
                    ...
                    {item.suggestions && item.suggestions.length > 0 && (
                      <div>
                        <h4 className="font-medium text-blue-700 mb-2 flex items-center">
                          <span className="mr-2">💡</span> Suggestions for Next
                          Time
                        </h4>
                        <ul className="space-y-2">
      ...
      <div className="mt-8 pt-8 border-t border-gray-200 no-print">
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          ...
          <p className="mt-1">
            Your session data is stored locally and will be available for 7
            days.
          </p>
        </div>
      </div>
